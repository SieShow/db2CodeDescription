...
export class ErrorModel {
  ...
  public appendCode(value: string): void {
    this.code = this.code === undefined ? value : this.code.concat(value);
  }
  ...
  public appendDestination(value: string): void {
    this.destination = this.destination === undefined ? value : this.destination.concat(value);
  }
  ...
  public appendDescription(value: string): void {
    this.description = this.description === undefined ? value : this.description.concat(value);
  }
  ...
  public appendExplanation(value: string): void {
    this.explanation = this.explanation === undefined ? value : this.explanation.concat(value);
  }
  ...
  public appendProgrammerResponse(value: string): void {
    this.programmer_response = this.programmer_response === undefined ? value : this.programmer_response.concat(value);
  }
  ...
  public appendSqlState(value: string): void {
    this.sql_state = this.sql_state === undefined ? value : this.sql_state.concat(value);
  }
  ...
  public appendNote(value: string): void {
    this.note = this.note === undefined ? value : this.note.concat(value);
  }
